...
function switchTab(tabId) {
    ...
    // Masaüstü Sekme butonlarını güncelle
    ...
    // Mobil Alt Bar butonlarını güncelle
...
function initMusicControls() {
    ...
    // Mobil Mini Müzik Çalar Butonları
    ...
    if (miniBtnPlayPause) {
        miniBtnPlayPause.onclick = (e) => {
            e.stopPropagation();
            togglePlayPause();
        };
    }
    if (miniBtnNext) {
        miniBtnNext.onclick = (e) => {
            e.stopPropagation();
            playNextTrack();
        };
    }
...
function updatePlayerUI(index) {
    ...
    // Mobil Mini Çalar Bilgilerini Güncelle
